...
namespace NStorage.Test.POIFS.Properties
{
    ...
    public class TestPropertyFactory
    {
        ...
        public void TestConvertToProperties()
        {
            ...
            List<NStorage.Properties.Property> properties = PropertyFactory.ConvertToProperties(rawData);
            ...
            bool[] isNull =
        {
            ...
            for (int j = 0; j < 64; j++)
            {
                ...
                else
                {
                    ...
                    Assert.AreEqual(names[j], ((NStorage.Properties.Property)properties[j]).Name, "Checking property " + j);
                }
            }
        }
