...
namespace NStorage.Test.POIFS.Properties
{
    ...
    public class TestPropertyTable
    {
        ...
        public void TestReadingConstructor()
        {
            ...
            int count = 0;
            NStorage.Properties.Property child = null;
            IEnumerator<NStorage.Properties.Property> iter = table.Root.Children;

            while (iter.MoveNext())
            {
                child = (NStorage.Properties.Property)iter.Current;
                ++count;
            }
            if (child == null)
