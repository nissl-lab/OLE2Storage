...
using NStorage.Utility.Collections;
...
namespace NStorage.Utility
{
    public class Arrays
    {
        ...
        public static String DeepToString(Object[] a) {
            ...
            DeepToString(a, buf, new NStorage.Utility.Collections.HashSet<Object[]>());
            return buf.ToString();
        }

        private static void DeepToString(Object[] a, StringBuilder buf,
                                         NStorage.Utility.Collections.HashSet<Object[]> dejaVu)
        {
            if (a == null)
            {
                buf.Append("null");
